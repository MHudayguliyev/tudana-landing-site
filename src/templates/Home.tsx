                ...
                <div className='flex flex-row lg:flex-col justify-center md:justify-start flex-wrap gap-4 mt-5'>
                  ...
                  {/* <div className='flex gap-4 flex-wrap'>
                    ...
                    <div className='relative flex items-center gap-2 p-3 rounded-full lg:rounded-lg bg-pink-300 hover:transition hover:duration-300'>
                        ...
                        <span className='hidden lg:block' itemProp='telephone'> <a href="tel:+99361767336">+99361767336</a> </span>
                    </div>
                    <div className='relative flex items-center gap-2 p-3 rounded-full lg:rounded-lg bg-pink-300 hover:transition hover:duration-300'>
                        <Image src={strawberry} alt="image" width={26} height={26}/>
                  ...
                  <div className='flex gap-4 flex-wrap'>
                    {
                      ...
                      <>
                        {data!.map(item => (
                          <div key={item.service_guid} className='relative flex items-center gap-2 p-3 rounded-full lg:rounded-lg bg-pink-300 hover:transition hover:duration-300'>
                              ...
                              <span className='hidden lg:block' itemProp='telephone'> <a href="tel:+99363935225">{item.service_contact}</a></span>
                          </div>
                        ))}
                      </>
                    }
